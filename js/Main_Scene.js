class BaseScene extends Phaser.Scene {
    ...
    update() {
        ...
        if (this.player.x >= 207){} else if (this.input.activePointer.x >= 205 & this.input.activePointer.isDown) {
        ...
        if (this.player.x <= 160){} else if (this.input.activePointer.x <= 205 & this.input.activePointer.isDown) {
            this.player.body.x -= 45
            if (this.input.activePointer.isDown = false) {
                this.player.body.x = 0
            }
